...
const ar: SiteContent = {
  ...
  hero: {
    display: 'اكتشف <span class="hl">إمكانات العقارات قيد الإنشاء</span> واستثمر في منزل أحلامك',
    lede: 'آلاف <span style="color:#5DCEF7">المستثمرين يتهافتون على دبي</span>. الأسعار ترتفع. الوحدات الجيدة تُحجَز قبل الإعلان. استثمر الآن في عقارات دبي المربحة واستفد من خطط سداد مرنة وعوائد استثنائية. ارتقِ بمستقبلك المالي اليوم.',
    bullets: [
    ...
    phoneCardTitle: 'اترك رقمك الآن لتحصل على <span class="hl">استشارة استثمارية مجانية.</span>',
  ...
  story: {
    title: 'خبرة تمتد لعشرين عاماً في سوق العقارات، <span class="hl">القصة الكاملة.</span>',
    expandText: 'اقرأ القصة كاملة...',
    paragraphs: [
      'نحن في شركة إيهاب عيّاد العقارية، نتمتّع بخبرة تمتد لأكثر من عشرين عاماً في سوق العقارات في دبي. بدأنا رحلتنا بفهم عميق لاحتياجات المستثمرين، وبنينا سمعةً مرموقة قائمة على الشفافية والمصداقية والنتائج الملموسة. ساعدنا آلاف العملاء من جميع أنحاء العالم على امتلاك عقارات في دبي وتحقيق أرباح استثنائية.',
    ],
    verifyTitle: 'تحقّق من مصداقيتنا',
    verifyText: 'الثقة تُبنى على الأدلّة، لا على الوعود. تصفّح سندات الملكية وبطاقات الإنجاز أدناه. تحقّق، ثم قرّر أن تثق.',
    moreParagraphs: [
      'ما يميّزنا، أنّنا لا نرشّح أبداً مشروعاً لم نستثمر فيه نحن أوّلاً. خبرتنا الميدانية وأبحاثنا الدقيقة توفّر عليك سنوات من التجربة والخطأ. نختار لك أفضل الفرص الاستثمارية في عقارات دبي قيد الإنشاء، وندير العملية من البداية إلى النهاية.',
      'على مدى السنوات، بنت شركتنا سمعةً رائدة في السوق، وساعدت مستثمرين من كل قارّات العالم على تحقيق أهدافهم العقارية. واليوم، نكرّس خبرتنا وفريقنا لكلّ من يمنحنا ثقته.',
    ],
  },
  awards: {
  ...
  inquiry: {
    title: 'احصل على استشارة مع <span class="hl">إيهاب عيّاد العقارية.</span>',
    stats: [
      { value: '20+ عام', label: { ar: 'خبرة في السوق', en: 'Market Experience' } },
      { value: '1000+', label: { ar: 'عميل نجحوا معنا', en: 'Successful Clients' } },
      { value: '1 مليار+', label: { ar: 'قيمة مبيعات', en: 'Sales Value' } },
    ],
    ...
    items: [
      {
        ...
        headline: { ar: 'إيهاب عيّاد العقارية تشارك في معرض توظيف الإماراتيين.', en: '' },
        featured: true,
      },
      {
        image: 'news-02.webp',
        ...
        headline: { ar: 'صبحا العقارية تستضيف إيهاب عيّاد العقارية ضمن دائرتها المغلقة.', en: '' },
      },
      {
        image: 'news-03.webp',
        tag: { ar: 'جائزة', en: 'Award' },
        date: { ar: 'ديسمبر 2024', en: 'December 2024' },
        headline: { ar: 'داماك العقارية تُكرّم إيهاب عيّاد العقارية كثاني أعلى الوكلاء مبيعاً.', en: '' },
      },
      {
        image: 'news-04.webp',
        tag: { ar: 'إنجاز', en: 'Milestone' },
        date: { ar: 'أكتوبر 2025', en: 'October 2025' },
        headline: { ar: 'مبيعات إيهاب عيّاد العقارية تتخطّى المليار درهم منذ تأسيسها.', en: '' },
      },
      {
        image: 'news-05.webp',
        tag: { ar: 'تكريم حكومي', en: 'Govt Recognition' },
        date: { ar: 'سبتمبر 2024', en: 'September 2024' },
        headline: { ar: 'دائرة الأراضي والأملاك تُصنّف إيهاب عيّاد العقارية حليفاً استراتيجياً.', en: '' },
      },
    ],
  },
  quotes: {
    signature: 'إيهاب عيّاد العقارية',
  },
  footer: {
    tagline: 'استشارات عقارية متكاملة في دبي تحت الإنشاء. مرخّصون من دائرة الاقتصاد ودائرة الأراضي والأملاك.',
    exploreTitle: 'استكشف',
    exploreLinks: [
    ...
    copyright: '© 2026 شركة إيهاب عيّاد العقارية',
    ...
    steps: [
      {
        ...
        rows: [
          ...
          { label: 'اسم الحساب', value: 'Iheb Ayed Properties' },
      ...
      },
      {
        ...
        body: 'أرسل صورة أو ملف PDF لإيصال التحويل إلى info@ihebayed.com',
      },
      {
...
const en: SiteContent = {
  ...
  hero: {
    display: 'Explore the <span class="hl">potential of under-construction properties</span> and invest in your future home',
    lede: 'Thousands of <span style="color:#5DCEF7">investors are flocking to Dubai</span>. Prices are rising. Prime units are booked before they\'re announced. Invest now in Dubai real estate with flexible payment plans and exceptional returns. Secure your financial future today.',
    bullets: [
    ...
    phoneCardTitle: 'Leave your number now for a <span class="hl">free investment consultation.</span>',
  ...
  story: {
    title: 'Two decades of expertise in the real estate market, <span class="hl">the complete story.</span>',
    expandText: 'Read the full story...',
    paragraphs: [
      'At Iheb Ayed Properties, we bring over two decades of expertise in the Dubai real estate market. Our journey began with a deep understanding of investor needs, and we have built a reputation grounded in transparency, credibility, and exceptional results. We have helped thousands of clients worldwide own property in Dubai and achieve outstanding returns.',
    ],
    verifyTitle: 'Verify our track record',
    verifyText: 'Trust is built on evidence, not promises. Browse the title deeds and achievement certificates below. Verify, then decide to trust.',
    moreParagraphs: [
      'What sets us apart is that we never recommend a project we haven\'t invested in ourselves first. Our hands-on experience and thorough research save you years of trial and error. We select the best investment opportunities in Dubai\'s off-plan market and manage the entire process from start to finish.',
      'Over the years, our company has built a leading reputation in the market, helping investors from every continent achieve their real estate goals. Today, we dedicate our expertise and team to everyone who places their trust in us.',
    ],
  },
  awards: {
  ...
  inquiry: {
    title: 'Get a consultation with <span class="hl">Iheb Ayed Properties.</span>',
    stats: [
      { value: '20+ Years', label: { ar: 'خبرة في السوق', en: 'Market Experience' } },
      { value: '1000+', label: { ar: 'عميل نجحوا معنا', en: 'Successful Clients' } },
      { value: '1B+ AED', label: { ar: 'قيمة مبيعات', en: 'Sales Value' } },
    ],
    nameLabel: 'Full Name',
    ...
    items: [
      {
        ...
        tag: { ar: 'حدث', en: 'Event' },
        date: { ar: 'نوفمبر 2024', en: 'November 2024' },
        headline: { ar: '', en: 'Iheb Ayed Properties participates in the Emirati Employment Fair.' },
        featured: true,
      },
      {
        image: 'news-02.webp',
        tag: { ar: 'شراكة', en: 'Partnership' },
        date: { ar: 'أغسطس 2025', en: 'August 2025' },
        headline: { ar: '', en: 'Sobha Realty hosts Iheb Ayed Properties in its inner circle.' },
      },
      {
        image: 'news-03.webp',
        tag: { ar: 'جائزة', en: 'Award' },
        date: { ar: 'ديسمبر 2024', en: 'December 2024' },
        headline: { ar: '', en: 'DAMAC Properties honors Iheb Ayed Properties as second highest-selling agent.' },
      },
      {
        image: 'news-04.webp',
        tag: { ar: 'إنجاز', en: 'Milestone' },
        date: { ar: 'أكتوبر 2025', en: 'October 2025' },
        headline: { ar: '', en: 'Iheb Ayed Properties sales surpass AED 1 billion since founding.' },
      },
      {
        image: 'news-05.webp',
        tag: { ar: 'تكريم حكومي', en: 'Govt Recognition' },
        date: { ar: 'سبتمبر 2024', en: 'September 2024' },
        headline: { ar: '', en: 'Dubai Land Department classifies Iheb Ayed Properties as a strategic ally.' },
      },
    ],
  },
  quotes: {
    signature: 'Iheb Ayed Properties',
  },
  footer: {
    tagline: 'Comprehensive off-plan real estate consultancy in Dubai. Licensed by the Dubai Economy Department and Dubai Land Department.',
    ...
    copyright: '© 2026 Iheb Ayed Properties',
    ...
    steps: [
      {
        ...
        rows: [
          ...
          { label: 'Account Name', value: 'Iheb Ayed Properties' },
      ...
      },
      {
        ...
        body: 'Send a photo or PDF of the transfer receipt to info@ihebayed.com',
      },
      {
